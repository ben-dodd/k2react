...
import { auth, questionsRef, quizzesRef, usersRef } from 'config/firebase'
            ...
            {this.state.isLoading ? (
              ...
              <div>
                ...
                <Typography className={classes.note}>
                  <b>Date completed: </b>
                  {this.state.read ? moment(this.state.read).format('D MMMM YYYY') : 'N/A'}
                </Typography>
                          ...
                          {unansweredList.includes(q.uid) ? (
                            ...
                            <div>
                              {questionScores[index] > 0 ? (
                                <div style={{ color: 'green' }}>{questionScores[index]}% Correct</div>
                              ) : (
                    ...
                    {questions.map((q) => {
                      switch (q.type) {
                        ...
                        case 'multimulti':
                          return (
                            <MultiMultiQuestion
                              ...
                              onChanged={(e) => this.onMultiChecked(q.uid, e.target.value)}
                            />
                          )
                        case 'shortstring':
                        ...
                        case 'imageselectsingle':
                          return (
                            <ImageSelectSingleQuestion q={q} key={q.uid} onChanged={(e) => this.onSingleChanged(q.uid, e.target.value)} />
                          )
