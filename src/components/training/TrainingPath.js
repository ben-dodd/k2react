          ...
          <div>
            ...
            <div style={{ marginTop: 12 }}>
              {this.allStepsCompleted() ? (
                ...
                <div>
                  <Button disabled={activeStep === 0} onClick={this.handleBack} style={{ marginRight: 12 }}>
                    Back
                  </Button>
                  <Button variant='contained' color='primary' onClick={this.handleNext} style={{ marginRight: 12 }}>
                    Next
                  </Button>
