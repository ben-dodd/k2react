...
import { storage, trainingPathsRef } from 'config/firebase'
...
import { handleModalChange, handleModalChangeStep, handleModalSubmit, hideModal, onUploadFile } from 'actions/modal'
